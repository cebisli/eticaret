      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="{{ route('kadin_urunler') }}">
              <figure class="image">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <a class="block-2-item" href="{{ route('cocuk_urunler') }}">
              <figure class="image">
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <a class="block-2-item" href="{{ route('erkek_urunler') }}">
              <figure class="image">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            <h4>Tüm Ürünlerimizde 50% İnidirim</h4>
            <p>Seçili ürünlerde indirim fırsatlarını kaçırmayın!</p>
            <p><a href="{{ route('indirim_urunler') }}" class="btn btn-primary btn-sm">İndirimdeki Ürünler</a></p>
          </div>
        </div>
      </div>
    </div>
